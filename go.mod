...
// Core: ohmycggk/mihomo fork, branch feat/nowhere2 (commit 9f2c7e0d, based on upstream v1.19.31)
replace github.com/metacubex/mihomo => github.com/ohmycggk/mihomo v1.19.31-nw.1
